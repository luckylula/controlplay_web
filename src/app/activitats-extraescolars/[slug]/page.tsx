          ...
          <>
            ...
            <ul className="mt-3 space-y-2 text-slate-600">
              <li className="flex items-start gap-2">
                <span className="mt-0.5 text-blue-600 shrink-0" aria-hidden>✔</span>
...
function FutbolSalaContent() {
  return (
    <>
      <ActivityImagesLayout
        imageLeft="/images/extraescolars/futbol-sala/futbol sala1.png"
        imageRight="/images/extraescolars/futbol-sala/futbol sala2.png"
        description={
          <>
            <h2 className="text-xl font-semibold text-slate-900 sm:text-2xl">Descripció</h2>
            <p className="mt-3 text-slate-600">
...
function ArtAttackContent() {
  return (
    <>
      <ActivityImagesLayout
        imageLeft="/images/extraescolars/art-attack/artattack1.png"
        imageRight="/images/extraescolars/art-attack/artattack2.png"
        description={
          <>
            <h2 className="text-xl font-semibold text-slate-900 sm:text-2xl">Descripció</h2>
            <p className="mt-3 text-slate-600">
...
function MinichefContent() {
  return (
    <>
      <ActivityImagesLayout
        imageLeft="/images/extraescolars/minichef/minichef1.png"
        imageRight="/images/extraescolars/minichef/minichef2.png"
        description={
          <>
            <h2 className="text-xl font-semibold text-slate-900 sm:text-2xl">Descripció</h2>
            <p className="mt-3 text-slate-600">
...
function RoboticaContent() {
  return (
    <>
      <ActivityImagesLayout
        imageLeft="/images/extraescolars/robotica/robotica1.png"
        imageRight="/images/extraescolars/robotica/robotica2.png"
        description={
          <>
            <h2 className="text-xl font-semibold text-slate-900 sm:text-2xl">Descripció</h2>
            <p className="mt-3 text-slate-600">
...
function TallerCienciaContent() {
  return (
    <>
      <ActivityImagesLayout
        imageLeft="/images/extraescolars/taller-ciencia/ciencia1.png"
        imageRight="/images/extraescolars/taller-ciencia/ciencia2.png"
        description={
          <>
            <h2 className="text-xl font-semibold text-slate-900 sm:text-2xl">Descripció</h2>
            <p className="mt-3 text-slate-600">
...
function EscacsContent() {
  return (
    <>
      <ActivityImagesLayout
        imageLeft="/images/extraescolars/escacs/escacs1.png"
        imageRight="/images/extraescolars/escacs/escacs2.png"
        description={
          <>
            <h2 className="text-xl font-semibold text-slate-900 sm:text-2xl">Descripció</h2>
            <p className="mt-3 text-slate-600">
