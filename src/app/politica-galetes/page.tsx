...
export const metadata: Metadata = {
  ...
  description: "Política de galetes, textos legals i informació general – Control Play.",
};

export default function PoliticaGaletesPage() {
  return (
    <div className="mx-auto max-w-4xl px-4 py-16 sm:px-6 lg:px-8">
      <h1 className="text-3xl font-bold text-slate-900 sm:text-4xl">Textos legals i Política de privacitat</h1>

      <h2 className="mt-10 text-xl font-bold text-slate-900">Informació general del Controlplaysports.com</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
        Controlplaysports.com (<a href="https://www.controlplaysports.com" className="text-emerald-600 hover:underline" target="_blank" rel="noopener noreferrer">https://www.controlplaysports.com</a>) és un domini de CONTROL PLAY SPORTS S.L. amb C.I.F. B-65565228 i domicili al Carrer de Barcelona nº 100 de Sant Vicenç dels Horts (Baix Llobregat), 08620, tel. 93 010 21 91 i adreça electrònica <a href="mailto:info@controlplay.cat" className="text-emerald-600 hover:underline">info@controlplay.cat</a>. Mitjançant el domini Controlplaysports.com, l&apos;empresa gestiona el seu portal web, sense perjudici que puntualment o de manera permanent hi pugui haver altres adreces electròniques que també permetin accedir als continguts i serveis prestats mitjançant el lloc web Controlplaysports.com.
      </p>

      <h2 className="mt-10 text-xl font-bold text-slate-900">Accés dels usuaris</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <h2 className="mt-10 text-xl font-bold text-slate-900">Protecció dels drets de propietat intel·lectual i industrial</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <p className="mt-3 text-slate-700 leading-relaxed">
        Sempre que se citi informació de Controlplaysports.com a altres pàgines web hi haurà d&apos;haver com a mínim, un enllaç cap a la portada de <a href="https://www.controlplaysports.com" className="text-emerald-600 hover:underline" target="_blank" rel="noopener noreferrer">https://www.controlplaysports.com</a>.
      </p>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <ul className="mt-3 list-inside list-disc space-y-2 text-slate-700">
        <li>La presentació d&apos;una pàgina del portal Controlplaysports.com o qualsevol contingut d&apos;aquesta pàgina en una finestra que no pertany a Controlplaysports.com per mitjà de qualsevol tècnica o procediment incloent-hi framing, inline linking, etc.</li>
        <li>Una extracció d&apos;elements del lloc web que causi perjudici a Controlplaysports.com conforme a les disposicions vigents.</li>
        <li>L&apos;ús comercial dels continguts del lloc web Controlplaysports.com.</li>
        <li>L&apos;ús de marques o signes distintius, logotips, combinacions de colors, estructura, disseny i, en general, símbols distintius de qualsevol naturalesa, propietat de Control Play Sports, sense el coneixement i l&apos;autorització corresponent de l&apos;empresa.</li>
        ...
        <li>Provocar danys en els sistemes físics i lògics de Control Play Sports, dels seus proveïdors o de terceres persones; introduir o difondre a la xarxa virus informàtics o altres sistemes físics o lògics que siguin susceptibles de provocar danys anteriorment esmentats.</li>
      </ul>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <h2 className="mt-10 text-xl font-bold text-slate-900">Protecció de dades de caràcter personal</h2>

      <h3 className="mt-6 text-lg font-semibold text-slate-900">I – Dades recollides a través de formularis</h3>
      <p className="mt-3 text-slate-700 leading-relaxed">
        D&apos;acord amb el que disposa la Llei Orgànica 15/99, del 13 de desembre de 1999, sobre Protecció de dades de caràcter personal, CONTROL PLAY SPORTS i el seu lloc web <a href="https://www.controlplaysports.com" className="text-emerald-600 hover:underline" target="_blank" rel="noopener noreferrer">https://www.controlplaysports.com</a> compleixen la legislació vigent respecte a la protecció de dades personals i de contacte dels seus subscriptors/es i els manté en la més estricta confidencialitat. En concordança amb la normativa actualment vigent en matèria de protecció de dades (LOPD), així com en matèria de serveis de la societat de la informació i de comerç electrònic (LSSI-CE), l&apos;usuari/a accepta que les dades aportades per mitjà d&apos;aquesta pàgina web siguin incorporades a fitxers titularitat de CONTROL PLAY SPORTS, amb la finalitat de facilitar la prestació dels serveis sol·licitats. Els clients/es i/o usuaris/es de https://www.controlplaysports.com poden, en tot moment, exercitar els drets d&apos;accés, rectificació, cancel·lació i oposició sobre les seves dades personals tractades per Control Play Sports, en els termes i les condicions previstes en el títol III de la LOPD, comunicant-ho per correu electrònic a <a href="mailto:info@controlplay.cat" className="text-emerald-600 hover:underline">info@controlplay.cat</a>, o a l&apos;adreça de Control Play Sports que consta al principi d&apos;aquest avís legal.
      </p>

      <h3 className="mt-6 text-lg font-semibold text-slate-900">II – Dades de navegació</h3>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <h2 className="mt-10 text-xl font-bold text-slate-900">Responsabilitat sobre contingut i ús</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <p className="mt-3 text-slate-700 leading-relaxed">
        Controlplaysports.com no es fa responsable de la informació o els continguts que pengin els usuaris de controlplaysports.com, que restarà sota la seva pròpia responsabilitat.
      </p>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <h2 className="mt-10 text-xl font-bold text-slate-900">Dret d&apos;exclusió</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <h2 className="mt-10 text-xl font-bold text-slate-900">Registre d&apos;usuari i subscripcions</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
      ...
      <h2 className="mt-10 text-xl font-bold text-slate-900">Modificació de les presents condicions i durada</h2>
      <p className="mt-3 text-slate-700 leading-relaxed">
